...
<body>
  <div class="wrapper">
    ...
    <div class="content">
      <div>Esto es un ejemplo usando la <a href="https://github.com/mnico/Khipu" target="_blank">Biblioteca Khipu</a> para consultar estado de una cuenta de khipu</div>
      <div>
        <form method="POST">
          <div class="field">
